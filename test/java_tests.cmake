...
serializer_generate_java(TARGET serializer_java_test_schema
  SCHEMA java/all_types.serializer OUTPUT "${java_test_directory}/TestSchema.java")
serializer_generate_java(TARGET serializer_java_test_account
  SCHEMA "${PROJECT_SOURCE_DIR}/example/java/round_trip/account.serializer"
...
serializer_generate(TARGET serializer_java_interop
  SCHEMAS "${PROJECT_SOURCE_DIR}/example/java/round_trip/account.serializer"
...
add_test(NAME serializer_java_cli
  COMMAND "${CMAKE_COMMAND}" "-DGENERATOR=$<TARGET_FILE:serializer>"
    ...
    "-DSCHEMA=${PROJECT_SOURCE_DIR}/example/java/round_trip/account.serializer"
